...
loss_wt_lst1 =  [1.0, 10.0, 100.0] #[0.001, 0.01, 0.1] #
loss_wt_lst2 = [1.0, 10.0, 100.0] #[0.001, 0.01, 0.1] #
...
for seed in range(start_seed, start_seed + num_runs):
    for dataset, params in lst_datasets:
        for buffer_size in lst_buffer_size:
            ...
            for p in prob:
                exp_id = f"de-v1-{buffer_size}-{dataset}-p{p}-al{alpha_derp}-b{beta_derp}-s{seed}"
