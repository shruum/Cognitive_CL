...
job = yaml.safe_load(open(r'template_old.yaml'))
                        ...
                        for loss_wt3 in train_params['loss_wt_lst3']:
                            for loss_wt4 in train_params['loss_wt_lst4']:
                                ...
                                if loss_wt1 == loss_wt3 and loss_wt2 == loss_wt4:
                                    exp_id = f"ccl-ibl-lab-{buffer_size}-{dataset}-l{loss_wt1}{loss_wt2}-up{ema_update_freq}-s{seed}"
                                else:
                                    exp_id = f"ccl-ibl-lab-{buffer_size}-{dataset}-l{loss_wt1}{loss_wt2}-up{ema_update_freq}-s{seed}"
