...
loss_wt_lst1_best_cif100 =  [0.1]
loss_wt_lst2_best_cif100 =  [0.1]
lst_ema_update_freq_cif100 = [0.08]
                        ...
                        for ema_update_freq in train_params['ema_update_freq_lst']:
                            for loss_type in train_params['loss_types']:
                                for loss_wt1, loss_wt2 in zip(train_params['loss_wt_lst1'],train_params['loss_wt_lst2']):
                                    ...
                                    exp_id = f"cll4-{buffer_size}-{dataset}-a{alpha}b{beta}-lr{lr}-{loss_type}{loss_wt1}{loss_wt2}-up{ema_update_freq}-s{seed}"
