...
class DerppMMEma(ContinualModel):
    NAME = 'der_mm_ema'
    COMPATIBILITY = ['class-il', 'domain-il', 'task-il', 'general-continual']

    def __init__(self, backbone, loss, args, transform, aux_transform=None):
        super(DerppMMEma, self).__init__(backbone, loss, args, transform)
    ...
    def update_ema_model_variables(self):
        ...
        for ema_param, param in zip(self.ema_net2.parameters(), self.net.parameters()):
