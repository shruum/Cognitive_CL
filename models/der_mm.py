...
class DerMM(ContinualModel):
    NAME = 'der_mm'
    COMPATIBILITY = ['class-il', 'domain-il', 'task-il', 'general-continual']

    def __init__(self, backbone, loss, args, transform, aux_transform=None):
        super(DerMM, self).__init__(backbone, loss, args, transform)
    ...
    def observe(self, inputs, labels, not_aug_inputs):
        ...
        self.opt2.zero_grad()
        loss_dict = {}
        loss_aux_mem12 = loss_aux_mem21 = loss_log_12 = loss_log_21 = 0
        ...
        self.aux.collate_loss(loss_dict, loss_ce=loss_ce1, loss_aux=loss_aux12, loss_aux_mem=loss_aux_mem12, loss_logit_mem=loss_log_12, m1=True)
        self.aux.collate_loss(loss_dict, loss_ce=loss_ce2, loss_aux=loss_aux21, loss_aux_mem=loss_aux_mem21, loss_logit_mem=loss_log_21, m1=False)
